            ...
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-border">
                    <div className="space-y-4">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Your Study Plans</h1>
                            <p className="text-muted-foreground mt-2 max-w-xl text-lg">
                                Manage your personalized learning paths and track your progress towards your goals.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-wrap gap-3">
                        <Button variant="ghost" asChild className="text-muted-foreground hover:text-foreground">
                            <Link href="/study-hub" className="flex items-center gap-2">
